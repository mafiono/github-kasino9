...
const netcentsResponse = lazy(() =>
  import('./views/PaymentGatway/netcentsResponse')
);
...
const Wlt_balancehistory = lazy(() =>
  import('./views/profile/MyWallet/Balencehistory')
);

const Pro_profileinfo = lazy(() =>
  import('./views/profile/MyProfile/MyProfile')
);
const Pro_changepassword = lazy(() =>
  import('./views/profile/MyProfile/ChangePassword')
);
...
const ForgotPasswordverify = lazy(() =>
  import('./views/pages/forgotpassword_reset')
);
const EmailverifyResend = lazy(() => import('./views/pages/emailverifyresend'));

const NewPorker = lazy(() => import('./views/newpoker'));
...
class AppRouter extends React.Component {
  ...
  componentDidUpdate(prevProps, _prevState) {
    if (this.props.firstpagesettingtrackcode) {
      if (
        prevProps.firstpagesettingtrackcode !==
        this.props.firstpagesettingtrackcode
      ) {
    ...
    return (
      <Router history={history}>
        ...
        <Switch>
          ...
          <AppRoute path="/new-poker" component={NewPorker} fullLayout />
          ...
          <AppRoute
            path="/paymentGateWay/netcents_receive"
            component={netcentsResponse}
            VerticalLayout
          />
          <AppRoute
            path="/PaymentGateway/qpayResponse/:param1"
            component={QpayResponse}
            VerticalLayout
          />
          <AppRoute
            path="/PaymentGateway/YaarResponse/:param1"
            component={YaarResponse}
            VerticalLayout
          />
          <AppRoute path="/emailverify/:param1" component={Emailverify} />
          <AppRoute
            path="/forgotpasswordverify/:param1"
          ...
          <RequireAuth>
            <AppRoute
              path="/welcometobonuspage"
              component={Welcometobonuspage}
            />
            <AppRoute path="/emailverifysend" component={EmailverifyResend} />
            <AppRoute
              path="/mywallet/deposit"
              component={Wlt_deposit}
              VerticalLayout
            />
            <AppRoute
              path="/mywallet/withdraw"
              component={Wlt_withdraw}
              VerticalLayout
            />
            <AppRoute
              path="/mywallet/balance-history"
              component={Wlt_balancehistory}
              VerticalLayout
            />
            <AppRoute
              path="/myprofile/profile-info"
              component={Pro_profileinfo}
              VerticalLayout
            />
            <AppRoute
              path="/myprofile/change-password"
              component={Pro_changepassword}
              VerticalLayout
            />
            <AppRoute
              path="/myprofile/security"
              component={Pro_security}
              VerticalLayout
            />
            <AppRoute
              path="/myprofile/news-letter"
              component={Pro_news}
              VerticalLayout
            />
            <AppRoute
              path="/Mybets/sports"
              component={Bet_sports}
              VerticalLayout
            />
            <AppRoute
              path="/Mybets/casinos"
              component={Bet_casinos}
              VerticalLayout
            />
            <AppRoute
              path="/Bonuses/sports"
              component={Bns_sports}
              VerticalLayout
            />
            <AppRoute
              path="/Bonuses/casinos"
              component={Bns_casinos}
              VerticalLayout
            />
            <AppRoute
